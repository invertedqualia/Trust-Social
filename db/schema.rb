...
ActiveRecord::Schema[7.0].define(version: 2024_02_13_073507) do
  ...
  create_table "dislikes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "status_id"], name: "index_dislikes_on_account_id_and_status_id", unique: true
    t.index ["account_id"], name: "index_dislikes_on_account_id"
    t.index ["status_id"], name: "index_dislikes_on_status_id"
  end

  create_table "distrusts", force: :cascade do |t|
    t.bigint "account_id", null: false
    t.bigint "status_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "status_id"], name: "index_distrusts_on_account_id_and_status_id", unique: true
    t.index ["account_id"], name: "index_distrusts_on_account_id"
    t.index ["status_id"], name: "index_distrusts_on_status_id"
  end
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "status_id"], name: "index_likes_on_account_id_and_status_id", unique: true
  ...
  create_table "statuses", id: :bigint, default: -> { "timestamp_id('statuses'::text)" }, force: :cascade do |t|
    ...
    t.boolean "trendable"
    t.bigint "ordered_media_attachment_ids", array: true
    t.boolean "fact_checked", default: false, null: false
    t.boolean "debunked", default: false
  ...
  create_table "trusts", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["account_id", "status_id"], name: "index_trusts_on_account_id_and_status_id", unique: true
    t.index ["account_id"], name: "index_trusts_on_account_id"
    t.index ["status_id"], name: "index_trusts_on_status_id"
  end
  ...
  add_foreign_key "dislikes", "accounts", on_delete: :cascade
  add_foreign_key "dislikes", "statuses", on_delete: :cascade
  add_foreign_key "distrusts", "accounts", on_delete: :cascade
  add_foreign_key "distrusts", "statuses", on_delete: :cascade
  ...
  add_foreign_key "trusts", "accounts", on_delete: :cascade
  add_foreign_key "trusts", "statuses", on_delete: :cascade
