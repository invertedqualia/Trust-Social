...
module AccountAssociations
  ...
  included do
    ...
    has_many :likes, inverse_of: :account, dependent: :destroy
    has_many :dislikes, inverse_of: :account, dependent: :destroy
    has_many :mentions, inverse_of: :account, dependent: :destroy
    has_many :notifications, inverse_of: :account, dependent: :destroy
    has_many :conversations, class_name: 'AccountConversation', dependent: :destroy, inverse_of: :account
    has_many :scheduled_statuses, inverse_of: :account, dependent: :destroy
    has_many :trusts, inverse_of: :account, dependent: :destroy
    has_many :distrusts, inverse_of: :account, dependent: :destroy
