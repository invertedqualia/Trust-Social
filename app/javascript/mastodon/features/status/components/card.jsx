...
import bannerFactChecked from '../../../../images/banner_fact_checked.png';
import bannerDebunked from '../../../../images/banner_debunked.png';
...
export default class Card extends PureComponent {
  ...
  static propTypes = {
    ...
    factChecked: PropTypes.bool,
    debunked: PropTypes.bool,
  };
  ...
  render () {
    ...
    if (interactive) {
      ...
      embed = (
        <div className='status-card__image'>
          {canvas}
          {this.props.factChecked && <img src={bannerFactChecked} alt={bannerFactChecked} style={{ position: 'absolute', top: '-8px', left: '-10px' }} />}
          {this.props.debunked && <img src={bannerDebunked} alt={bannerDebunked} style={{ position: 'absolute', top: '-8px', left: '-10px', width: '27.5%' }} />}
          {thumbnail}
        </div>
      );
    } else {
