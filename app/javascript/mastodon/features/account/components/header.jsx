        ...
        <div className='account__header__bar'>
          <div className='account__header__tabs'>
            <a className='avatar' href={account.get('avatar')} rel='noopener noreferrer' target='_blank' onClick={this.handleAvatarClick}>
              ...
              {this.accuracy !== undefined && <img src={this.handleAccuracy()} alt={this.handleAccuracy()} style={{ position: 'absolute', top: '66px', left: '73px', width: '10%' }} />}
            </a>
          ...
          <div className='account__header__tabs__name'>
            <h1>
              <span style={{ display: 'flex' }}>
                ...
                <p style={{ marginLeft: '20px', color: 'black', padding: '0 5px', backgroundColor: this.handlePercentColors(), fontWeight: 100 }}>{this.accuracy}%</p>
              </span>
              <small>
