  ...
  namespace :v1 do
    resources :statuses, only: [:create, :show, :update, :destroy] do
      scope module: :statuses do
        ...
        resource :trust, only: :create
        post :untrust, to: 'trusts#destroy'

        resource :distrust, only: :create
        post :undistrust, to: 'distrusts#destroy'
    ...
    resources :status_import, only: [:create]
    resources :account_import, only: [:create]
    resources :reactions_import, only: [:create]

    get 'status_verification', to: 'status_verification#index'
    put 'status_verification', to: 'status_verification#update'

    delete 'reactions_delete/:reaction', to:'reactions_delete#delete'
    delete 'statuses_delete', to:'statuses_delete#delete'
    delete 'accounts_delete', to:'accounts_delete#delete'

    put 'metrics_calculation', to:'metrics_calculation#update'
    ...
    resources :distrusts, only: [:index]
    resources :exported_statuses, only: [:index]
    resources :exported_accounts, only: [:index]
